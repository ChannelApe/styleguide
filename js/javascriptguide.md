---
title: Channel Ape Javascript Style Guide
---
...
## Objects
  ...
  - [3.3](#es6-object-shorthand) You can Use object method shorthand or longhand. Keep it consistent throughout the project. eslint: [`object-shorthand`](http://eslint.org/docs/rules/object-shorthand.html) jscs: [`requireEnhancedObjectLiterals`](http://jscs.info/rule/requireEnhancedObjectLiterals)
  ...
  - [3.4](#es6-object-concise) Use property value shorthand or longhand. Keep it consistent throughout the project. eslint: [`object-shorthand`](http://eslint.org/docs/rules/object-shorthand.html) jscs: [`requireEnhancedObjectLiterals`](http://jscs.info/rule/requireEnhancedObjectLiterals)
...
## Strings
  ...
  <a name="strings--doublespace"></a>
  - [6.6](#strings--doublespace) Any sentence after punctuation in a string must be followed by 2 spaces. eslint: [`no-singlespace-after-punctuation`](http://eslint.org/docs/rules/no-singlespace-after-punctuation)

    > Why? Single spaces harm readability, thus double spaces should be used when punctuation is used in a string.

    ```javascript
    // bad
    const foo = 'People that use single spaces after punctuation are bad people. This sentence is hard to read because of single space after punctuation.';

    // good
    const foo = 'People that use double spaces after punctuation are great.  This sentence is pleasant to read because of double space after punctuation.';
    ```
...
## Testing
  ...
  - [30.2](#testing--for-real) **No, but seriously**:
    ...
    - We primarily use [`jasmine`](https://www.npmjs.com/package/jasmine) at ChannelApe. 
...
## Contributors
  ...
  - [View Contributors](https://github.com/ChannelApe/styleguide/graphs/contributors)
...
- 10/24/2017 -> forked from airbnb, added ChannelApe first iteration of modifications.
